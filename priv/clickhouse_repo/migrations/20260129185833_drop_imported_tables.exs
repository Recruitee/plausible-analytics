defmodule Plausible.ClickhouseRepo.Migrations.DropImportedTables do
  use Ecto.Migration

  def up do
    drop_if_exists table(:imported_browsers)
    drop_if_exists table(:imported_devices)
    drop_if_exists table(:imported_entry_pages)
    drop_if_exists table(:imported_exit_pages)
    drop_if_exists table(:imported_locations)
    drop_if_exists table(:imported_operating_systems)
    drop_if_exists table(:imported_pages)
    drop_if_exists table(:imported_sources)
    drop_if_exists table(:imported_visitors)
  end
